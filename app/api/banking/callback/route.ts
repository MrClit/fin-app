...
export const GET = withAuth(
  ...
  // Es un callback de navegador, no una llamada fetch: sin sesión se redirige al
  // login en vez de devolver un 401 JSON.
  { unauthorized: () => NextResponse.redirect(`${process.env.NEXT_PUBLIC_APP_URL}/login`) }
)
