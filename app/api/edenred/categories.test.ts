...
// El scraper (`parseMovement` en scripts/scrapers/edenred/parsers.mjs) emite estos ids sin tipado,
// por eso este test los protege explícitamente.
// - 'restaurant': consumo (fallback del webhook en route.ts)
// - 'payroll':    recarga / top-up (RECARGA en scripts/scrapers/edenred/parsers.mjs)
