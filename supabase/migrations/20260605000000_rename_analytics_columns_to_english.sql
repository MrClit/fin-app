-- Issue #35 (chore): unificar identificadores al inglés.
-- Renombra las columnas de salida en castellano de la capa de analítica:
--   ingresos -> income, gastos -> expense, ahorro -> savings.
-- Afecta a la vista materializada transactions_monthly_summary y a get_period_data.
-- No cambia la lógica de agregación ni la clasificación por categories.type (#63).
--
-- Ejecutar en Supabase SQL Editor como un único bloque.

-- ============================================================
-- 1. Recrear la vista materializada con columnas en inglés
-- ============================================================
...
-- ============================================================
-- 2. Recrear get_period_data con columnas de salida en inglés
-- ============================================================
