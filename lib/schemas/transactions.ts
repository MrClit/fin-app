...
/** Alta manual de movimiento (`createTransaction` en `app/actions/transactions.ts`). */
...
/**
 * Update parcial (`updateTransaction` en `app/actions/transactions.ts`): solo se tocan los campos
